...
public enum PlayerSkin {
  BLUE("/graphics/hull-blue.png", "/graphics/gun-blue.png", 0, 0), //
  RED("/graphics/hull-red.png", "/graphics/gun-red.png", 1, 1), //
  YELLOW("/graphics/hull-yellow.png", "/graphics/gun-yellow.png", 0, 1), //
  GREEN("/graphics/hull-green.png", "/graphics/gun-green.png", 1, 0), //
